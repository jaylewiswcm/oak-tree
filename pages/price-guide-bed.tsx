...
const PriceGuideBed = () => {
  return (
    <>
    <NextSeo  
        title="Bed Prices Explained | Oak Tree Mobility"
        description="Take a look at the Oak Tree Mobility bed price guide and find out more about the range of mobility products available to suit your budget"
    />
     ...
     <div className='guide-section con-reg'>
         ...
         <div className='section-question'>
             ...
             <div className='answer-block'>
                 <p className='highlighted'>People often ask us why there aren’t any prices on our website or why we can’t provide immediate quotes online or over the phone. The answer is simple: <em>our bed are made for you.</em></p>
         ...
         <div className='banner'>
             ...
             <div className='title-block'>
                 ...
                 <h3>1000’s<br/>Combinations</h3>
             </div>
         </div>
         <div className='choices'>
             <p className='title'>Our beds can be customised with a choice of:</p>
         ...
         <div className='flex-sections'>
             ...
             <div className='content'>
                 <p className='title'>These options allow you to pick a combination that works for you</p>
     ...
     <div className='guide-section con-reg'>
         <div className='section-question secondary-question'>
             ...
             <div className='answer-block'>
                 <p className='highlighted'>Companies that advertise with prices are able to do so because they offer stock beds in standard sizes with limited or basic accessories.</p>
            ...
            <div className='cta-flex'>
                ...
                <Link href='/adjustable-beds'>
                    <a className='cta'>
                        ...
                        <h6>View our <br/>Adjustable Beds</h6>
                    </a>
                </Link>
            </div>
        </div>
