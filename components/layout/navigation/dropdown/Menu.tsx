...
const menuConfig = [
  ...
  },
  {
    ...
    menu1: {
      ...
      options: [
              { title: "The Oak", desc: "A Touch of Elegance", icon : "/icons/products/navigation/oak.svg", url: '/chairs/the-oak' },
              { title: "The Maple", desc:"Stylish and Modern", icon : "/icons/products/navigation/maple.svg", url: '/chairs/the-oak' },
              { title: "The Cedar", desc:"Distinguished and Charming", icon : "/icons/products/navigation/cedar.svg", url: '/chairs/the-oak' },
              { title: "The Rowan", desc:"Sleek and Sumptous", icon : "/icons/products/navigation/rowan.svg", url: '/chairs/the-oak' },
              { title: "The Tulip", desc:"Truly Superior Comfort", icon : "/icons/products/navigation/tulip.svg", url: '/chairs/the-oak' },
  ...
  },
  {
    ...
    menu1: {
      ...
      options: [
              { title: "The Poplar", desc:"Innovative Comfort and Great Design", icon : "/icons/products/navigation/poplar.svg", url: '/adjustable-beds/the-hazel' },
              { title: "The Lilac", desc:"Innovation and stylish", icon : "/icons/products/navigation/lilac.svg", url: '/adjustable-beds/the-hazel' },
              { title: "The Hazel", desc:"An Elegant and Refined Bed", icon : "/icons/products/navigation/hazel.svg", url: '/adjustable-beds/the-hazel' },
              { title: "The Hesper", desc:"Eye Catching With Style", icon : "/icons/products/navigation/hesper.svg", url: '/adjustable-beds/the-hazel' },
              { title: "The Oysterwood", desc:"A Versatile Bed With Plenty of Style", icon : "/icons/products/navigation/oysterwood.svg", url: '/adjustable-beds/the-hazel' },
              { title: "The Birch", desc:"Modern Technology and British Style", icon : "/icons/products/navigation/birch.svg", url: '/adjustable-beds/the-hazel' },
